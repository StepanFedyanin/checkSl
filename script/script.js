...
function ModalKatalog(e,katalog){
	...
	if(obj.classList.contains("Modalkatalog__item--label")||obj.classList.contains("Modalkatalog__item--input")){
		let SizeCharrCheck = document.querySelectorAll(".choise");
		for(let countSizeCheck = 0;countSizeCheck<SizeCharrCheck.length; countSizeCheck++){
			SizeCharrCheck[countSizeCheck].classList.remove("choise");
		}
		obj.parentNode.classList.add("choise");
	}
}
